...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <div>
                <input type="checkbox" className="form-radio form-switch" name="completed"
                    id="wd-update-assignment-completed" defaultChecked={todo.completed}
            ...
            <input defaultValue={todo.description} className="form-control w-75 float-start me-2"
